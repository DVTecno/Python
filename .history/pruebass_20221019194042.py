...
def get_currency(url, headers, parameters):
  ...
  if (cripto_lastest):
    for cripto in cripto_lastest:
        coin = {}
        coin['nombre'] = cripto['name'] ;coin['simbolo'] = cripto['symbol'] ;coin['precio'] = cripto['quote']['USD']['price']; coin['volumen_24h'] = cripto['quote']['USD']['volume_24h']; coins[coin['simbolo']] = coin; return coins;
