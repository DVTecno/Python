...
with open("Glosario.txt",) as file1:
    ...
    file1.seek(0)#vuelve a la primer linea del archivo
...
with open("Glosario.txt","w") as file1:
    ...
    print(f"Se puede escribir en archivo? {file1.writable()}")#specifics si esta en modo lecture o no
...
with open("Glosario.txt","a") as file1:
    ...
    print(f"Se puede escribir en el archivo? {file1.writable()}") #writable devuelve True o False
